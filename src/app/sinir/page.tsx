...
export default async function SinirPage() {
  ...
  async function handleEmitirMTR(formData: FormData) {
    ...
    const geradorId = getValidString(formData, 'geradorId', 36) || '';
    const transportadorId = getValidString(formData, 'transportadorId', 36) || '';
    const destinadorId = getValidString(formData, 'destinadorId', 36) || '';
